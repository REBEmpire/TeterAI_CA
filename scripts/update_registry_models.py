    ...
    registry = ModelRegistry(
        ...
        capability_classes={
            CapabilityClass.REASON_DEEP: CapabilityConfig(
                tier_1=ModelConfig(provider="anthropic", model="claude-3-opus-20240229", max_tokens=8192),
            ...
            CapabilityClass.REASON_STANDARD: CapabilityConfig(
                tier_1=ModelConfig(provider="anthropic", model="claude-3-5-sonnet-20241022", max_tokens=4096),
            ...
            CapabilityClass.CLASSIFY: CapabilityConfig(
                tier_1=ModelConfig(provider="anthropic", model="claude-3-5-haiku-20241022", max_tokens=1024),
            ...
            CapabilityClass.GENERATE_DOC: CapabilityConfig(
                tier_1=ModelConfig(provider="anthropic", model="claude-3-5-sonnet-20241022", max_tokens=8192),
                tier_2=ModelConfig(provider="google", model="gemini-3.1-pro-preview", max_tokens=8192),
                tier_3=ModelConfig(provider="xai", model="grok-4-1-fast-reasoning", max_tokens=8192)
            ),
            CapabilityClass.EXTRACT: CapabilityConfig(
                tier_1=ModelConfig(provider="anthropic", model="claude-3-5-haiku-20241022", max_tokens=2048),
            ...
            CapabilityClass.MULTIMODAL: CapabilityConfig(
                tier_1=ModelConfig(provider="anthropic", model="claude-3-opus-20240229", max_tokens=4096),
