...
# 1. Update Divergence Trend Endpoint
divergence_trend = """
...
if "def get_divergence_trend" not in content:
    # Insert it right before the last function or another grading function
    content = content.replace("@router.get(\"/projects/\", response_model=List[ProjectSummary])", divergence_trend + "\n@router.get(\"/projects/\", response_model=List[ProjectSummary])")
