...
CONSTRAINTS: list[str] = [
    ...
    # SpecSection nodes are project-scoped; section_number is NOT globally unique.
    # DrawingSheet uses NODE KEY (sheet_number, project_id); SpecSection relies on
    # MERGE {section_number, project_id} for idempotency (no separate constraint needed
    # because baseline seed nodes omit project_id and would violate a composite key).
